...
import { startSearch, stopSearch, isSearching, searchDuration } from "~/stores/recorder";
    ...
    <div class="header-bar">
      <div class="search-row">
        ...
        <div class="tooltip-wrapper">
          <button
            class={`play-search ${isSearching() ? 'searching' : ''}`}
          ...
          >
            ...
            {isSearching() && <span class="search-indicator">{searchDuration()}s</span>}
          </button>
          <span class="tooltip">Play to search {isSearching() ? '(Recording...)' : ''}</span>
        </div>
      </div>
